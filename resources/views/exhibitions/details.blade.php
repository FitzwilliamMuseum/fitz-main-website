...
<div class="col-12 shadow-sm p-3 mx-auto mb-3 rounded ">
  <ul>
    @if($coll['exhibition_url'])
    <li><a href="$coll['exhibition_url']">Exhibition website</a></li>
    @endif
    @if($coll['exhibition_start_date'])
    <li>Exhibition run: {{  Carbon\Carbon::parse($coll['exhibition_start_date'])->format('l dS F Y') }} to
      {{  Carbon\Carbon::parse($coll['exhibition_end_date'])->format('l dS F Y') }}</li>
      @endif
    </div>
    @if($coll['youtube_id'])
