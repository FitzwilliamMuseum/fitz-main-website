...
@section('content')
    ...
    <div class="col-12 shadow-sm p-3 mx-auto mb-3 article">
        <figure class="figure float-right p-3">
            <img src="{{ $stop['hero_image']['data']['thumbnails']['7']['url']}}"
                 alt="{{ $stop['hero_image_alt_text'] }}" class="img-fluid"
                 loading="lazy"
                 height="{{ $stop['hero_image']['data']['thumbnails']['7']['height'] }}"
            ...
            <a class="btn btn-dark m-1 p-2" href="{{$stop['hero_image']['data']['full_url']  }}"
