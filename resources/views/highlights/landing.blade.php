...
@section('hero_image',env('CONTENT_STORE') . 'DISCOVER-OUR-COLLECTION%20(FINAL).png')
...
@section('collection-parallax', env('CONTENT_STORE') . 'DISCOVER-OUR-COLLECTION%20(FINAL).png')
