...
@section('content')
    <div class="text-center">
        <figure class="figure">
            <img src="{{ $pharos['image']['data']['url']}}"
                 alt="{{ $pharos['image_alt_text'] }}" class="img-fluid"
                 loading="lazy"
                 height="{{ $pharos['image']['height'] }}"
                 width="{{ $pharos['image']['width'] }}"
            />
            ...
            <div class="col-12 shadow-sm p-3 mx-auto mb-3 ">
                <div class="ratio ratio-16x9">
                    <iframe title="A video from YouTube related to {{ $pharos['title'] }}"
                            src="https://www.youtube.com/embed/{{$pharos['youtube_id']}}"
            ...
            <div class="col-12 shadow-sm p-3 mx-auto mb-3">
                <div class="ratio ratio-4x3">
                    <iframe title="A 3D model of {{ $pharos['title'] }}"
                            src="https://sketchfab.com/models/{{ $pharos['sketchfab_id']}}/embed?"
