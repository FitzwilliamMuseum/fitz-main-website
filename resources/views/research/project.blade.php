...
<div class="container">
    ...
    <div class="row">
        ...
        <x-partner-card :altTag="$partner['partner']['partner_full_name']"
            :title="$partner['partner']['partner_full_name']" :image="$partner['partner']['partner_logo']"
    ...
    <div class="col-12 col-max-800 shadow-sm p-3 mx-auto mb-3 ">
        <div class="ratio ratio-16x9">
            <iframe title="A YouTube video related to this story"
                src="https://www.youtube.com/embed/{{$project['youtube_id']}}" allowfullscreen></iframe>
        </div>
    </div>
</div>
@endsection
