...
@section('hero_image','https://content.fitz.ms/fitz-website/assets/img_20190105_153947.jpg?key=carousel')
...
@section('news')
  ...
  @section('fundraising')
    <div class="container mt-3">
      <h2>Support the Fitzwilliam Museum</h2>
      <div class="row">
    ...
    @if(!empty($shopify))
      @section('shopify')
        <div class="container">
          <h2 class="mt-3"><a href="https://curatingcambridge.co.uk/collections/the-fitzwilliam-museum">Gifts from the Fitzwilliam Museum shop</a></h2>
          <div class="row">
