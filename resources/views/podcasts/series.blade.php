...
<div class="col-12 col-max-800 shadow-sm p-3 mx-auto mb-3 ">
    <div class="ratio ratio-16x9">
        <iframe title="A YouTube video related to this podcast series"
            src="https://www.youtube.com/embed/{{$ids['youtube_id']}}" allowfullscreen></iframe>
    </div>
</div>
@endif
@if(!empty($podcasts))
...
<div class="row">
    ...
    <x-image-card :altTag="$podcast['hero_image_alt_tag'] " :title="$podcast['title']" :image="$podcast['hero_image']"
        :route="'podcasts.episode'" :params="[$podcast['slug']]"></x-image-card>
    @endforeach
</div>
@endif
...
<div class="container">
    ...
    <div class="row">
        ...
        <x-image-card :altTag="$presenter['associated_people_id']['display_name']"
            ...
            :image="$presenter['associated_people_id']['profile_image']" :route="'podcast.presenter'"
