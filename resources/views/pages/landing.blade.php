    ...
    <div class="container">
        <div class="row">
            @if (Request::is('about-us'))
                ...
                <x-static-image-card :title="'Latest news'" :route="'news'" :params="[]" :image="'https://content.fitz.ms/fitz-website/assets/img_20190105_153947.jpg?key=exhibition'"
                    :alt="'Fitzwilliam Museum ceiling'"></x-static-image-card>

                <x-static-image-card :title="'Our staff'" :route="'about.our.staff'" :params="[]" :image="'https://content.fitz.ms/fitz-website/assets/img_20191219_184304_832.jpeg?key=exhibition'"
            ...
            @foreach ($associated['data'] as $project)
                <x-image-card :altTag="$project['hero_image_alt_text']" :title="$project['title']" :image="$project['hero_image']" :route="'landing-section'"
