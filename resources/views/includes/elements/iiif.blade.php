      ...
      @if(array_key_exists('type', $id))
        @if($id['type'] === 'priref')
          <div class="embed-responsive embed-responsive-16by9">
            <iframe src="https://collection.beta.fitz.ms/uv.html#?manifest=https://api.fitz.ms/data-distributor/iiif/object-{{ $id['value']}}/manifest&c=0&m=0&cv=0&config=https://collection.beta.fitz.ms/config.json&locales=en-GB:English (GB),cy-GB:Cymraeg,fr-FR:Français (FR),sv-SE:Svenska,xx-XX:English (GB) (xx-XX)&xywh=-2139,-341,9925,5028&r=0"
