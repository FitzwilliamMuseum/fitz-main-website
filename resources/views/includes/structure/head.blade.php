<div class="container-fluid head parallax position-relative">
  <div class="absolute-bottom w-100">
    ...
    <div class="mr-3">
      <a tabindex="0" class="further-info fa-stack fa-lg float-right mr-4 mb-4" role="button" data-toggle="lightbox"
      data-remote="@yield('hero_image')" data-content="@yield('hero_image_title')">
      <i class="fa fa-circle fa-stack-2x"></i>
