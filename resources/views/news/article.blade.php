...
<div class="col-12 col-max-800 shadow-sm p-3 mx-auto mb-3 ">
    <div class="ratio ratio-16x9">
        <iframe title="A YouTube video related to this story"
            src="https://www.youtube.com/embed/{{$news['youtube_id']}}" allowfullscreen></iframe>
    </div>
</div>
@endif
...
<div class="col-12 col-max-800 shadow-sm p-3 mx-auto mb-3 ">
    <div class="ratio ratio-16x9">
        <iframe title="A Vimeo Video related to this story" src="https://player.vimeo.com/video/{{$news['vimeo_id']}}"
