...
@foreach($insta['data'] as $instagram)
  ...
  @if(!empty($instagram['hero_image']))
    @section('hero_image', $instagram['hero_image']['data']['url'])
          ...
          <div class="col-md-7 mb-3">
            <div class=" shadow-sm p-3 mb-3 mt-3">
              <figure class="figure">
                ...
                <a class="btn btn-dark" href="{{ URL::to( $instagram['hero_image']['data']['full_url'] )  }}" target="_blank"
