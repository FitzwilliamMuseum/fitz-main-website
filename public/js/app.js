...
/* harmony import */ var _nav__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./nav */ "./resources/js/nav.js");
/* harmony import */ var _nav__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_nav__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _related_content_grid__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./related-content-grid */ "./resources/js/related-content-grid.js");
/* harmony import */ var _related_content_grid__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_related_content_grid__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./cards */ "./resources/js/cards.js");
/* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_cards__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _consentchecker__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./consentchecker */ "./resources/js/consentchecker.js");
/* harmony import */ var _consentchecker__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_consentchecker__WEBPACK_IMPORTED_MODULE_10__);
...
var cardsArray = document.querySelectorAll('[data-component="card"]');

if (cardsArray.length > 0) {
  // Loop through cards adding a click event and identifying the main link
  cardsArray.forEach(function (card) {
    var mainLink = card.querySelector('.card__link') || card.querySelector('.stretched-link');
...
window.addEventListener('DOMContentLoaded', function () {
  var soundcloudEmbeds = document.querySelectorAll('.soundcloud-embed-component');

  if (soundcloudEmbeds && soundcloudEmbeds.length > 0) {
    soundcloudEmbeds.forEach(function (embed) {
      var embedContainer = embed.querySelector('.container');
      var iframeEl = embed.querySelector('iframe');
      var iframeSrc = iframeEl.getAttribute('src');
      ...
      if (window.cc && window.cc.hasConsented('analytics')) {
        ...
        if (embed.classList.contains('cookies-rejected')) {
          ...
          if (embedContainer.querySelector('.cookies-rejected__message')) {
            var cookiesMessage = embedContainer.querySelector('.cookies-rejected__message');
        ...
        var cookiesText = document.createElement('p');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var toggleButtons = document.querySelectorAll('[data-toggle="true"]');
  ...
  if (toggleButtons.length) {
    ...
    document.addEventListener('click', function (event) {
      ...
      if (event.target.matches('[data-toggle="true"]')) {
        var toggleTarget = event.target.previousElementSibling;

        if (event.target.matches('[aria-expanded="false"]')) {
          closeDisclosures();
          event.target.setAttribute('aria-expanded', 'true');
          toggleTarget === null || toggleTarget === void 0 ? void 0 : toggleTarget.setAttribute('data-item-expanded', 'true');
        } else {
          event.target.setAttribute('aria-expanded', 'false');
          toggleTarget === null || toggleTarget === void 0 ? void 0 : toggleTarget.removeAttribute('data-item-expanded');
        }
      }
    });
...
/***/ "./resources/js/related-content-grid.js":
/*!**********************************************!*\
  !*** ./resources/js/related-content-grid.js ***!
  \**********************************************/
/***/ (() => {
...
window.addEventListener("DOMContentLoaded", function () {
  var grid = document.querySelectorAll(".related .related-grid");
  if (!grid) return;
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/backtotop.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/cookieconsent.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/config.js")))
