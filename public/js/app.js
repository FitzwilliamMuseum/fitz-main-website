...
/* harmony import */ var _search_bar__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./search-bar */ "./resources/js/search-bar.js");
/* harmony import */ var _search_bar__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_search_bar__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./cards */ "./resources/js/cards.js");
/* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_cards__WEBPACK_IMPORTED_MODULE_10__);
...
if (cardsArray.length > 0) {
  ...
  cardsArray.forEach(function (card) {
    var mainLink = card.querySelector('.stretched-link');
...
function moveSearchDonateContainer() {
  ...
  var container = document.querySelector("#search-donate-container");
  var element = document.querySelector("#search-donate-container");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var main_search = document.querySelector("#main-search");
  var main_navbar = document.querySelector("nav.navbar");
  var navbar_toggler = document.querySelector(".navbar-toggler");

  function updateMargins() {
    var navbarHeight = main_navbar.getBoundingClientRect().height;
    var searchHeight = main_search.getBoundingClientRect().height;
