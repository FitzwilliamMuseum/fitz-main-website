...
class BasicRoutesTest extends TestCase
{
    ...
    {
        $parameterizedRoutes = [
            route('director', ['slug' => 'luke-syson']),
            route('collection', ['slug' => 'egypt']),
            route('department', ['slug' => 'curatorial']),
            route('research-project', ['slug' => 'ancient-egyptian-coffins']),
            route('gallery', ['slug' => 'gallery-3']),
            route('exhibition', ['slug' => 'made-in-ancient-egypt']),
            route('article', ['slug' => 'summer-at-the-fitzwilliam-2022']),
        ];
